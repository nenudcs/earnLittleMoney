...
public class TheoreticalPresentation{
    ...
    public void setScores(Double[] ids){
        ...
        setScoreTotal(score1 + score2 + score3 + score4 + score5);
    }

    public TheoreticalPresentation(Integer id, Integer candidateId, Integer judgeId, Double score1, Double score2, Double score3, Double score4, Double score5, Double scoreTotal) {
        this.id = id;
